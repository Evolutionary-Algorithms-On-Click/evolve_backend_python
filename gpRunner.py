...
class GpRunner:
    ...
    def __init__(self, id, arity=1):
        ...
        # Create directories.
        os.makedirs(f"gp/{id}/", exist_ok=True)

        # Create code file.
        self.code = open(f"gp/{id}/code.py", "w")
    ...
    def create(
        ...
        # )
        self.code.write(f"toolbox.register('evaluate', evalSymbReg, points=[x / 10.0 for x in range(-10, 10)], realFunction=\"{realFunction}\")\n\n")
    ...
    def run(
        ...
        exitCode = os.system(f"python -m scoop gp/{self.id}/code.py")
        return exitCode
    ...
    def createPlots(self):
        ...
        self.code.write("\tout_file.write(f\"Best individual fitness: {hof[0].fitness.values}\\n\")\n")
        # self.code.write("\tout_file.write(f\"Best individual: {hof[0]}\\n\")\n")
    ...
    def plotGraph(self):
        ...
        self.code.write("\tplt.savefig(f'{rootPath}/graph.png', dpi=300)\n")
